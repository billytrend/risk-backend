...
/**
 * The class holds the implementation of any random events such as first player
 * selection or dice throws.
 * 
 * It is also responsible for carrying out the fights. ----- should it be?
 * 
 */
public class Arbitration {
	...
	/**
	 * This method carries out the whole fight including dice throw, and the
	 * analysis of its result. It returns the FightResult instance which
	 * represents the amount of units that should be taken of both the defender
	 * and the attacker.
	 * 
	 * @param result
	 * @param dA
	...
	/**
	 * The method takes the result of dice throws and compares them to specify
	 * how many armies should be taken of each player. The returned FightResult
	 * instance contains an information about the amount of armies taken of the
	 ...
	 * @return
	 */
	private static FightResult arbitrateFight(FightResult result,
			Integer[] attacker, Integer[] defender) {
		...
		// that were thrown
		int numberToCompare = (attacker.length > defender.length) ? defender.length
				: attacker.length;
