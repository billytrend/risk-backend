...
/**
 * An interface allowing for a game to be played by AIs, locally by players, or
 * over network. A class that implements this interface provides a specific way
 * of communication with a player.
 * 
 */
