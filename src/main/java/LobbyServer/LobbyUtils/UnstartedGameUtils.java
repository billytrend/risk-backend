...
public class UnstartedGameUtils {
	...
	public void addPlayerToUnstartedGame(UnstartedGameGroup g,
			PlayerConnection p) {
	...
	public void removePlayerFromUnstartedGame(UnstartedGameGroup g,
			PlayerConnection p) {
		g.getPlayers().remove(p);
	}

	public HashSet<PlayerConnection> getPlayersInGroup(
			HashSet<UnstartedGameGroup> groups) {
	...
	public HashSet<PlayerConnection> getPlayersNotInGroup(
			HashSet<UnstartedGameGroup> groups, HashSet<PlayerConnection> a) {
