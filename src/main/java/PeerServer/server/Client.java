...
/**
 * @author 120011995
 * @category Class which acts as a client to connect to the multi-threaded
 *           PeerServer specified in PeerServer class
 */
public class Client {
	...
	/**
	 * Method which creates client connections and communicates messages to
	 * PeerServer class.
	 */
	public void clientConnection(String clientName) {
		int port = 4444;
		try {
			// create Client Socket and writer to used to send info to
			// PeerServer
