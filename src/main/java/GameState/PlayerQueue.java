...
/**
 * The class enabling to iterate through all players that are still in the game
 * - that haven't lost.
 *
 */
public class PlayerQueue implements Iterator {
	...
	/**
	 * Called when a player has lost all their territories and have to be
	 * removed from the game.
	 * 
	 * TODO: It should be also used when a player dissapears from the game
