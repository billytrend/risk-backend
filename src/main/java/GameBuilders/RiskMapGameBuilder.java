...
public class RiskMapGameBuilder {
	...
	public static void addRiskTerritoriesToState(State state){
		// creating territories
				...
				//Add continents
				ContinentUtils.addContinent(state, northAmerica, 5, "north_america");
				ContinentUtils.addContinent(state, southAmerica, 3, "south_america");
				ContinentUtils.addContinent(state, europe, 5, "europe");
				ContinentUtils.addContinent(state, africa, 2, "africa" );
				ContinentUtils.addContinent(state, asia, 7, "asia");
				ContinentUtils.addContinent(state, australia, 2, "australia");
