...
public class RuleUtilsTest {
	...
	public void applyFightResultTakeOverTest() {
		...
		assertEquals(
				ArmyUtils.getNumberOfArmiesOnTerritory(player1, territories[0]),
				1);
		assertTrue(TerritoryUtils.getPlayersTerritories(player1).contains(
				territories[1]));
		assertEquals(
				ArmyUtils.getNumberOfArmiesOnTerritory(player1, territories[1]),
				1);
	...
	public void applyFightResultTest() {
		...
		assertEquals(
				...
				1);
		assertEquals(
				ArmyUtils.getNumberOfArmiesOnTerritory(player2, territories[1]),
				3);
