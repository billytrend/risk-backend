...
public class CardUtilsTest {
	...
	public void testAddCard() throws Exception {
		...
		Iterator<Territory> it = this.st.getTerritories().vertexSet()
				.iterator();
	...
	public void testGivePlayerRandomCard() throws Exception {
		...
		assertTrue(CardUtils.getPlayersCards(this.st, aPlayer).get(0).equals(c)
		...
		assertNotEquals(CardUtils.getPlayersCards(this.st, aPlayer).get(0),
	...
	public void testGetCardsOfType() throws Exception {
		...
		assertEquals(4, CardUtils.getCardsOfType(this.st, CardType.SOLDIER)
				.size());
		assertEquals(1, CardUtils.getCardsOfType(this.st, CardType.CANNON)
				.size());
		assertEquals(1, CardUtils.getCardsOfType(this.st, CardType.HORSE)
				.size());
	}
	...
	public void testGetPossibleCardCombinations() throws Exception {
		...
		Card g = new Card(anotherTerr, CardType.SOLDIER);
		Card h = new Card(anotherTerr, CardType.SOLDIER);
		assertEquals(0, CardUtils.getPossibleCardCombinations(this.st, aPlayer)
				.size());
		CardUtils.addCard(this.st, c);
		CardUtils.addCard(this.st, d);
		CardUtils.addCard(this.st, e);
		...
		assertEquals(1, CardUtils.getPossibleCardCombinations(this.st, aPlayer)
				.size());
		assertTrue(CardUtils.getPossibleCardCombinations(this.st, aPlayer)
				.get(0).contains(c));
		assertTrue(CardUtils.getPossibleCardCombinations(this.st, aPlayer)
				.get(0).contains(d));
		assertTrue(CardUtils.getPossibleCardCombinations(this.st, aPlayer)
		...
		assertEquals(8, CardUtils.getPossibleCardCombinations(this.st, aPlayer)
				.size());
	}
}